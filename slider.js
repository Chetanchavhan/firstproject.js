function fetchData(){
    fetch("https://backend-6srh.onrender.com/workwear")
    .then((res)=>res.json())
    .then((data)=>list(data))
...
function datafetch(){
    fetch("https://backend-6srh.onrender.com/womensproduct")
    .then((res)=>res.json())
...
return tshirt;
    ...
    function fetchWomensData() {
        fetch("https://backend-6srh.onrender.com/tshirt")
            .then((res) => res.json())
    ...
    function fetchWomensshirtsData() {
        fetch("https://backend-6srh.onrender.com/womenshirts")
            .then((res) => res.json())
    ...
    function fetchmensworkData() {
        fetch("https://backend-6srh.onrender.com/mensworkwear")
            .then((res) => res.json())
    ...
    function fetchcapData() {
        fetch("https://backend-6srh.onrender.com/cap")
            .then((res) => res.json())
    ...
    function fetchwatchData() {
        fetch("https://backend-6srh.onrender.com/watch")
            .then((res) => res.json())
